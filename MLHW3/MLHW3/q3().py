...
print("\nMyLogisticRegression with Boston50:")
Mycrossval.my_cross_val("MylogisticReg",boston50input,boston50target,k)
print("\nMyLogisticRegression with Boston75:")
Mycrossval.my_cross_val("MylogisticReg",boston75input,boston75target,k)
