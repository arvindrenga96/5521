...
•	ParametricClassfier has all the function for MultiGaussclassify
•	Mycrossval has code for cross validation modified according to problem requirement.
...
•	After the above steps Do the following to run the codes(don't forget to put quotes for the python filename, they are required to read '(' and ')' ) 
	1.	To run q3(i) type 	python3 'q3().py'
